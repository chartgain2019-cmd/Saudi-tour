...
const path = require('path'); // أضيف هذا السطر

const app = express();
app.use(cors());
app.use(express.json());

// =========== إضافة هذه السطور الجديدة ===========
// خدم الملفات الثابتة من مجلد public
app.use(express.static(path.join(__dirname, 'public')));

// إذا كان لديك مشروع React/Vue، أضف هذا أيضاً:
...
// جميع الطلبات الأخرى ترجع إلى الواجهة الأمامية
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'public', 'index.html'));
  // أو إذا كنت تستخدم React/Vue:
